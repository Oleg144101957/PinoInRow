package com.pl.nk.col.lec.navigation
...
import com.pl.nk.col.lec.ui.screens.AboutScreen
...
fun NavigationHost(navController: NavHostController, innerPadding: PaddingValues) {
    NavHost(navController = navController, startDestination = ScreenRoutes.SplashScreen.route) {
        ...
        composable(route = ScreenRoutes.PlnkoScreen.route) {
            PlnkoScreen(navController, innerPadding)
        }

        composable(route = ScreenRoutes.InfoScreen.route) {
            InfoScreen(navController, innerPadding)
        }
